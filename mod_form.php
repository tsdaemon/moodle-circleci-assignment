 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class mod_circleci_assign_mod_form extends mod_assign_mod_form {
    ...
    public function definition() {
        ...
        $mform->addElement('text', 'circleci_url', get_string('circleci_url', 'circleci_assign'), array('size'=>'64'));
        $mform->addRule('circleci_url', null, 'required', null, 'client');

        $mform->addElement('text', 'circleci_token', get_string('circleci_token', 'circleci_assign'), array('size'=>'64'));
